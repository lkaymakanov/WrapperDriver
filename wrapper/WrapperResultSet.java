...
public class WrapperResultSet implements ResultSet{
	...
	public WrapperResultSet(ResultSet aRSet, WrapperStatement aParentStatement, boolean aDebugMode){
		mRSet = aRSet;
		mParentStatement = aParentStatement;
		this.mdebugMode = aDebugMode;
	}
	...
	public BigDecimal getBigDecimal(int arg0, int arg1) throws SQLException {
		return mRSet.getBigDecimal( arg0, arg1 );
	}
	...
	public Date getDate(String arg0, Calendar arg1) throws SQLException {
		return mRSet.getDate( arg0,arg1 );
	}
	
	public double getDouble(String arg0) throws SQLException {
		return mRSet.getDouble( arg0 );
	}
	...
	public Time getTime(String arg0, Calendar arg1) throws SQLException {
		return mRSet.getTime( arg0, arg1);
	}

	public Timestamp getTimestamp(int arg0) throws SQLException {
		return mRSet.getTimestamp( arg0 );
	}
	
	public Timestamp getTimestamp(int arg0, Calendar arg1) throws SQLException {
		return mRSet.getTimestamp(arg0, arg1);
	}
	...
	public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
		return mRSet.getBigDecimal(columnIndex);
    }

	public BigDecimal getBigDecimal(String columnName) throws SQLException {
		return mRSet.getBigDecimal(columnName);
    }
	...
	public java.sql.Date getDate(int columnIndex, Calendar cal) throws SQLException {
		return mRSet.getDate(columnIndex, cal);
    }

	public java.sql.Time getTime(int columnIndex, Calendar cal) throws SQLException {
		return mRSet.getTime(columnIndex, cal);
    }
	...
	public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
		...
		return mRSet.getObject(columnIndex, type);
	}

	@Override
	public <T> T getObject(String columnLabel, Class<T> type)
			throws SQLException {
		return mRSet.getObject(columnLabel, type);
	}
