 ...
 */
class WrapperStatement implements Statement {
	
	protected Statement mStmt;
	protected WrapperConnection mParentConnection;
	protected boolean mDebugMode;
	
	public WrapperStatement(Statement aStmt, WrapperConnection aParentConnection, boolean aDebugMode){
		mStmt = aStmt;
	...
	public ResultSet executeQuery(String arg0) throws SQLException {
		return new WrapperResultSet(mStmt.executeQuery(arg0), this, mDebugMode);
	}
	...
	public ResultSet getResultSet() throws SQLException {
		return new WrapperResultSet(mStmt.getResultSet(), this, mDebugMode);
	}
	...
	public ResultSet getGeneratedKeys() throws SQLException {
		return new WrapperResultSet(mStmt.getGeneratedKeys(), this, mDebugMode);
	}
