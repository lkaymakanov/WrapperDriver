...
public class WrapperConnection implements Connection {
	...
	public Statement createStatement() throws SQLException {
		return new WrapperStatement(mConn.createStatement(), this, mDebugMode);
	}
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
    	return new WrapperStatement(mConn.createStatement(resultSetType, resultSetConcurrency), this, mDebugMode);
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, 
    	...
    	return new WrapperStatement(mConn.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), this, mDebugMode);
    }
